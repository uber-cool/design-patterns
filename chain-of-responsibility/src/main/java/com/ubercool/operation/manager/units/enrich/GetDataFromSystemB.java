...
@Component
@Slf4j
public class GetDataFromSystemB extends AbstractEnhanceOperationUnit{

  @Override
  protected boolean execute(OperationContext context) {
    log.info("[SUB_STEP] Getting additional data from System B");
    String additionalData = "Data from B";
